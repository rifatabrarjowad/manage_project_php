...
include "conec.php";
    ...
    ?>
                                ...
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <input type="text" name="connection_charge" id="connection_charge"
                                        class="form-control">
                                </div>
                                <div class="form-group col-sm-2 col-xs-12">
                                    <font color="red"><label for="issue_pin">IP Qty</label></font>
                                    <input type="text" name="issue_pin" id="issue_pin" class="form-control" required="">
                                </div>
                                ...
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="Insert User IP" name="user_ip"
                                        id="user_ip" autocomplete="off">
                                </div>
                                <div class="form-group col-sm-2 col-xs-12">
