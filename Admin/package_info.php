        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div style="color: black; background: #a6d7ff; padding: 8px; border: 2px solid #055d9c; margin-bottom:5px;"
                    class="no_print">
                    <form id="package_form" action="pack.php" method="POST">
                        <div class="box-body">
...
include "conec.php";
    ...
    ?>
                                ...
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <div>
                                        <input class="form-control" name="pack_nam" id="" type="text" />
                                ...
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <div>
                                        <input class="form-control" name="band_nam" id="" type="text" />

                                    </div>
                                </div>
                                <div class="form-group col-sm-1 col-xs-12" style="margin-top: 25px;" id="insert_btn">
                                    <input type="submit" class="pull-left btn btn-success" value="submit" />
                                </div>
                            </div>
                        </div>
                    </form>
