        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div style="color: black; background: #a6d7ff; padding: 8px; border: 2px solid #055d9c; margin-bottom:5px;"
                    class="no_print">
                    <form id="expense_head_form" method="post" action="income_head_edite_done.php">
                        <div class="box-body">
...
include "conec.php";
    if (!$connection) {
        ...
        if (isset($_REQUEST['id'])) {
            ...
            $query = "SELECT * FROM income_head WHERE id = $rec_id";
                ...
                ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-xs-12">
                                    <label for="expense_head">Income Head</label>
                                    <input type="text" value="<?php echo "{$row['hand']}" ?> " name="expense_head"
                ...
                ?>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td style="text-align: center;"><a
                                                        href="income_head_edite.php?id= <?php echo "{$row['id']}" ?>">Edite</a>
                                                    ||
                                                    <a
                                                        href="income_head_del.php?id=<?php echo "{$row['id']}" ?>">Delete</a>
                                                </td>
                                            </tr>
