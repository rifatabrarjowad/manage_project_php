        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div style="color: black; background: #a6d7ff; padding: 8px; border: 2px solid #055d9c; margin-bottom:5px;"
                    class="no_print">
                    <form id="income_form" action="income_edite_done.php" method="post">
                        <div class="box-body">
...
include "conec.php";
    if (!$connection) {
        ...
        if (isset($_REQUEST['id'])) {
            ...
            $query = "SELECT * FROM income WHERE id = $rec_id";
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <input type="text" value="<?php echo "{$row['date']}" ?> "
                                        ...
                                        name="date" id="date" value="2020-10-27" required="" autocomplete="off">
                                </div>
                                <div class="form-group col-sm-2 col-xs-12">
            ...
            while ($row = mysqli_fetch_assoc($show)) {
                ?>
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <input type="text" name="amount" value="<?php echo "{$row['money']}" ?> "
