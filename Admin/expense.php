        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div style="color: black; background: #a6d7ff; padding: 8px; border: 2px solid #055d9c; margin-bottom:5px;"
                    class="no_print">
                    <form id="expense_form" action="expensend.php" method="post">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <input type="text" class="form-control new_datepicker hasDatepicker"
                                        placeholder="Insert Date" name="date" id="date" required="" autocomplete="off">
                                </div>
                                <div class="form-group col-sm-2 col-xs-12">
...
include "conec.php";
    ...
    ?>
                                ...
                                <div class="form-group col-sm-2 col-xs-12">
                                    ...
                                    <input type="text" value="" name="paid_by" class="form-control">
                                </div>
