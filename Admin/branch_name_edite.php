...
include "conec.php";
    if (!$connection) {
        ...
        if (isset($_REQUEST['id'])) {
            ...
            $query = "SELECT * FROM company_name WHERE id = $rec_id";
            $show = mysqli_query($connection, $query);
            while ($row = mysqli_fetch_assoc($show)) {
                ?>
                        <form id="branch_form" action="branch_name_edite_done.php" method="post">
                            <div class="box-body">
                               ...
                               color: green; font-weight: bolder; text-align: center;">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-3 col-xs-12">
                                        ...
                                        <input type=" text" name="branch_name" value="<?php echo "{$row['name']}" ?> "
                                            id="branch_name" class="form-control" required="">
                                    </div>
